...
export default function ReviewGallery({
    ...
    return (
        <section className="rg-section">
            ...
            <h2 style={{color: "#5d5340", paddingLeft: '4vw'}} className="rg-title">Client Testimonials</h2>
            ...
            >
                            {/* <h2 style={{color: "#5d5340"}} className="rg-title">Client Testimonials</h2> */}
                ...
                {slides.map((s, i) => {
                    ...
                    return (
                        <button
                            key={i}
                            className={`${spin ? "rg-spin-y-3" : ""} rg-item ${isActive ? "is-active" : active === null ? "is-idle" : "is-collapsed"}`}
                            //   onClick={expandable ? () => { setManual(true); setActive(isActive ? null : i); } : undefined}
                            onMouseEnter={() => {
                                setManual(true); setActive(i);
                            }}
                            onMouseLeave={() => {
                                setManual(false);
                                setActive(null);
                        ...
                        >
                            {active === i ? (
                                <span className={`rg-label ${active !== null && isActive ? "is-active" : "is-collapsed"}`}> {s.text}</span>
                            ) : (
